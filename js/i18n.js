...
(function (root) {
    ...
    const zh = {
        ...
        takeTitle: '评估成果',
        takeLead: '评估完成后可打开四份材料：商业模式、能力差距、优先事项与整份底稿。',
        open: '打开 →',
        thisScene: '打开这条 →',
        prev: '上一条',
        next: '下一条',
        ...
        sampleNote: '示意图为空模板，数字请以贵司经营数据核验。',
        backTake: '返回',
        missing: '没有这份材料',
        home: '回到首页继续浏览。',
        loginKicker: '从战略到执行',
        ...
        caseFitLead: '若符合其中两条及以上，建议按本案例启动评估。',
    ...
    const en = {
        ...
        takeTitle: 'Outputs',
        takeLead: 'After assessment you can open four materials: the business model, capability gaps, first moves, and the full pack.',
        open: 'Open →',
        thisScene: 'Open this →',
        prev: 'Previous',
        next: 'Next',
        ...
        sampleNote: 'Figures are empty templates. Verify numbers with your operating data.',
        backTake: 'Back',
        how1t: 'See the form',
        ...
        caseFitLead: 'If two or more apply, start the assessment with this case.',
        ...
        delMore: 'More outputs',
        backOutputs: 'Back to outputs',
